...
%--------------------------------------------------------------------------
% Image files
I = imread('images/blob.png');    %'2019_04_19_19_33_26_456_Ang_0.bmp');

% Measure shape parameters
boundaryPoint = 12;         %12, 10 number of boundary points curvature is found over 
curvatureThresh = 0.25;     %0.06 the maximum allowed value of the curvature measure
bp_tangent = 12;            % number of boundary points the tangent angle is found over 
...
fprintf('Curvature calculation time: %f seconds\n', toc);
